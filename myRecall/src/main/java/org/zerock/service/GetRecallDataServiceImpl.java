...
//	 				}
	...
	public ArrayList<RecallVO> getRecallPosts(String brand, String carName, String fromDate,int page, int size){
		 ...
		 //1. 검색조건에 해당하는 post 개수 파악 
		int totalPostCount = recallDataMapper.getRecallPostCount(brand,carName,fromDate);
		...
		ArrayList<RecallVO> posts = recallDataMapper.getRecallPosts(brand, carName, fromDate,pageCri);
 ...
 public RecallVO getRecallPost(int recallNum){
	 return recallDataMapper.getRecallPost(recallNum);
 }
