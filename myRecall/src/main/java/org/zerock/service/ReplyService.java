...
public class ReplyService {
	...
	// 댓글 삭제 
	public int delReply(String replyNum){
	 return	replyMapper.delReply(replyNum);
	};
	
	//댓글 수정 
	public int updateReply(String replyNum , String replyText){
		 return	replyMapper.updateReply(replyNum, replyText);
	};
